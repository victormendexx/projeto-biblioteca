...
from amanda.views import inicio, avaliacoes, sobre, catalogo, detalhes_livros, pegar_emprestado
...
urlpatterns = [
    ...
    path('pegar_emprestado/<str:livro_id>/', pegar_emprestado, name='pegar_emprestado'),
    ]
